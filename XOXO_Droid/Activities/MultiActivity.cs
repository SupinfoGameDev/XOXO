...
namespace XOXO_Droid
{
	...
	public class MultiActivity : Activity
	{
		...
		protected override void OnCreate (Bundle bundle)
		{
			...
			ProgressDialog scan = new ProgressDialog(this);
			scan.Indeterminate = true;
			scan.SetCanceledOnTouchOutside(false);
			scan.SetProgressStyle(ProgressDialogStyle.Spinner);
			scan.SetMessage("Scanning for devices...");
			scan.SetCancelable(true);
			scan.SetButton("Cancel", (s, ev) =>{
				if (btAdapter != null) {
